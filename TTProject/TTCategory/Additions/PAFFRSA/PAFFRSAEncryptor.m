...
#import "PAFFRSAEncryptor.h"
#import <Security/Security.h>
#import "NSData+Base64.h"


@implementation PAFFRSAEncryptor
{
    SecKeyRef publicKey;
...
static PAFFRSAEncryptor* sharedInstance = nil;

+(void) setSharedInstance: (PAFFRSAEncryptor*)instance
{
...
+(PAFFRSAEncryptor*) sharedInstance
{
    ...
    dispatch_once(&token, ^{
        sharedInstance = [[PAFFRSAEncryptor alloc]init];
    });
